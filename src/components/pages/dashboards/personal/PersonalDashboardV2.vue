        ...
        <div class="dashboard-card has-margin-bottom">
          ...
          <div class="active-projects">
            ...
            <VBlock title="Delivery App Project" subtitle="Updated 30m ago" center>
              <template #icon>
                <VAvatar
                  picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/apps/1.jpg"
            ...
            <VBlock title="Health and Fitness Dashboard" subtitle="Updated 5h ago" center>
              <template #icon>
                <VAvatar
                  picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/apps/2.png"
            ...
            <VBlock title="Learning Tracker Dashboard" subtitle="Updated 7h ago" center>
              <template #icon>
                <VAvatar
                  picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/apps/3.png"
            ...
            <VBlock title="Banking App Dashboard" subtitle="Updated 10h ago" center>
              <template #icon>
                <VAvatar
                  picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/apps/4.png"
