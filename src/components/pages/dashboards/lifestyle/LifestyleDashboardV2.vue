      ...
      <div class="column is-9">
        <div class="columns is-multiline is-flex-tablet-p">
          ...
          <div class="column is-3">
            <div
              v-background="{
                src: 'https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/1.jpg',
          ...
          <div class="column is-3">
            <div
              v-background="{
                src: 'https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/2.jpg',
                placeholder: 'https://via.placeholder.com/800x600',
              }"
              class="long-card has-background-image"
            >
          ...
          <div class="column is-3">
            <div
              v-background="{
                src: 'https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/3.jpg',
                placeholder: 'https://via.placeholder.com/800x600',
              }"
              class="long-card has-background-image"
            >
          ...
          <div class="column is-3">
            <div
              v-background="{
                src: 'https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/4.jpg',
                placeholder: 'https://via.placeholder.com/800x600',
              }"
              class="long-card has-background-image"
            >
            ...
            <div class="dashboard-list">
              ...
              <div class="inner-list">
                <VBlock title="Extreme Foot Trekk" subtitle="Oct 31, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/1.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                ...
                <VBlock title="Rafting trip" subtitle="Oct 30, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/2.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Climbing Group [Pro]" subtitle="Oct 31, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/3.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Bicycle Madness Trek" subtitle="Oct 31, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/4.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
            ...
            <div class="dashboard-list">
              ...
              <div class="inner-list">
                <VBlock title="Extreme Triathlon" subtitle="Nov 2, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/5.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Group Running" subtitle="Oct 29, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/6.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
                ...
                <VBlock title="Suit Diving" subtitle="Oct 28, 2020" center>
                  <template #icon>
                    <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/dashboards/lifestyle/7.jpg" squared />
                  </template>
                  <template #action>
                    <div class="rating">
                      <i aria-hidden="true" class="fas fa-star selected"></i>
