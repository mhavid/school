        ...
        <div class="card v-card">
          ...
          <div class="card-image">
            <figure class="image is-4by3">
              <img
                src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/30.jpg"
                alt=""
          ...
          <div class="card-content post-group-wrap">
            <div class="post-group">
              <a>
                <img
                  src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/33.jpg"
                  alt=""
                  @error.once="onceImageErrored(1280, 960)"
                />
              </a>
              <a>
                <img
                  src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/34.jpg"
                  alt=""
                  @error.once="onceImageErrored(1280, 960)"
                />
              </a>
              <a>
                <img
                  src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/35.jpeg"
                  alt=""
                  @error.once="onceImageErrored(1280, 960)"
                />
              </a>
              <a>
                <img
                  src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/36.jpg"
                  alt=""
                  @error.once="onceImageErrored(1280, 960)"
                />
              </a>
      ...
      <div class="column is-4">
        <div class="card v-card">
          ...
          <div class="card-image">
            <figure class="image is-4by3">
              <img
                src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/31.png"
                alt=""
                @error.once="onceImageErrored(1280, 960)"
              />
            </figure>
      ...
      <div class="column is-4">
        <div class="card v-card">
          ...
          <div class="card-image">
            <figure class="image is-4by3">
              <img
                src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/32.jpg"
                alt=""
                @error.once="onceImageErrored(1280, 960)"
              />
            </figure>
