      ...
      <div class="column is-4">
        ...
        <a href="#" class="dashboard-card is-interview">
          <VBlock title="Jonathan K." subtitle="08:00 - 09:00" center>
            <template #icon>
              <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpg32.jpg" />
            </template>
            <template #action>
        ...
        <a href="#" class="dashboard-card is-interview">
          <VBlock title="Greta K." subtitle="10:30 - 11:00" center>
            <template #icon>
              <VAvatar picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpg19.jpg" />
            </template>
            <template #action>
              <i aria-hidden="true" class="iconify" data-icon="feather:chevron-right"></i>
            </template>
