      ...
      <div class="fieldset">
        ...
        <div class="setting-list">
                      ...
                      <Multiselect
                        ...
                        :options="[
                          ...
                          },
                          {
                            value: 'jira',
                            name: 'Jira Software',
                            icon: 'https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/tools/jira.svg',
                          },
                          {
                            value: 'office',
                            name: 'MS Office',
                            icon: 'https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/tools/office.svg',
                          },
                        ]"
                      >
                        <template #singlelabel="{ value }">
          ...
          <template v-else>
            ...
            <!--Skill Item-->
            <div class="setting-item">
              <VIconWrap picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/tools/jira.svg" />
            ...
            <!--Skill Item-->
            <div class="setting-item">
              <VIconWrap picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/tools/office.svg" />
