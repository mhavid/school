    ...
    <div class="columns is-multiline">
      <div class="column is-4">
        <div class="dashboard-card is-company">
          <VAvatar
            size="big"
            picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/udemy.svg"
            picture-dark="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/udemy-dark.svg"
          >
            <template #badge>
            ...
            >
              <template #icon>
                <Tippy
                  ...
                  placement="top-start"
                >
                  <VAvatar size="medium" picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpg31.jpg" />
                  <template #content>
            ...
            >
              <template #icon>
                <Tippy
                  ...
                  placement="top-start"
                >
                  <VAvatar size="medium" picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpg23.jpg" />
                  <template #content>
            ...
            >
              <template #icon>
                <Tippy
                  ...
                  placement="top-start"
                >
                  <VAvatar size="medium" picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpg32.jpg" />
                  <template #content>
