              ...
              <div class="section-content">
                <div class="experience-wrapper">
                  <div class="experience-item">
                    <img
                      src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/airbnb.svg"
                      alt=""
                  ...
                  <div class="experience-item">
                    <img
                      src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/facebook.svg"
                      alt=""
                      @error.once="onceImageErrored(150)"
                    />
                    <div class="meta">
                  ...
                  <div class="experience-item">
                    <img
                      src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/atlassian.svg"
                      alt=""
                      @error.once="onceImageErrored(150)"
                    />
                    <div class="meta">
                  ...
                  <div class="experience-item">
                    <img
                      src="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/github.svg"
                      alt=""
                      @error.once="onceImageErrored(150)"
                    />
                    <div class="meta">
                ...
                <div class="skills-wrapper">
                  ...
                  <div class="skills-item">
                    ...
                    <div class="people">
                      ...
                      <VAvatar size="small" picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpg39.jpg" />
            ...
            <div class="profile-card-section no-padding">
              ...
              <div class="section-content">
                <div class="tools-wrapper">
                  ...
                  <!--Tool-->
                  <div class="tools-item">
                    <VIconWrap picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/jira.svg">
                      <template #after>
                        <VPeity
                          type="pie"
                          :values="[60, 100]"
                  ...
                  <!--Tool-->
                  <div class="tools-item">
                    <VIconWrap picture="https://jubi.co.id/wp-content/uploads/2020/06/Buah-jeruk-Tempo.co_.jpgphotos/brands/office.svg">
                      <template #after>
                        <VPeity
                          type="pie"
                          :values="[95, 100]"
